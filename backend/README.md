...
Сделал временный deprecate аппки rolls. Добавил auth через initData от самой телеги. Небольшие изменения в моделях.
Почистил вьюхи в packs, cases, users. Оптимизировал bot.py и packs/tasks.py, убрав апи запросы и дал доступ к моделям
напрямую.